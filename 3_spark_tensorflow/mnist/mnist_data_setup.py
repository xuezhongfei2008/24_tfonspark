...
if __name__ == "__main__":
  ...
  if not args.read:
    ...
    writeMNIST(sc, "/opt/algor/gongxf/python3_pj/nlp_practice/24_tfonspark/3_spark_tensorflow/mnist/data/train-images-idx3-ubyte.gz",
               "/opt/algor/gongxf/python3_pj/nlp_practice/24_tfonspark/3_spark_tensorflow/mnist/data/train-labels-idx1-ubyte.gz",
               args.output + "/train", args.format, args.num_partitions)
    writeMNIST(sc, "/opt/algor/gongxf/python3_pj/nlp_practice/24_tfonspark/3_spark_tensorflow/mnist/data/t10k-images-idx3-ubyte.gz",
               "/opt/algor/gongxf/python3_pj/nlp_practice/24_tfonspark/3_spark_tensorflow/mnist/data/t10k-labels-idx1-ubyte.gz",
